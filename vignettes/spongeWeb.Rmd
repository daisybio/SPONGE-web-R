...
<img src="https://raw.githubusercontent.com/IceQueen1996/spongeAPI/master/vignettes/proj_structure.PNG" alt="Structure SPONGE-Web project" style="width: 600px; display: block; margin-left: auto; margin-right: auto;"/>
...
<img src="https://raw.githubusercontent.com/IceQueen1996/spongeAPI/master/vignettes/geneCounts.PNG" alt="Structure SPONGE-Web project" style="width: 600px; display: block; margin-left: auto; margin-right: auto;"/>
...
```{r eval=FALSE}
get_geneCount(gene_symbol = c("CCD4"))
```
